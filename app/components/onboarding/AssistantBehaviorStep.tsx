...
export function AssistantBehaviorStep({
  data,
  onChange,
  onContinue,
}: AssistantBehaviorStepProps) {
  return (
    <div className="w-full max-w-160 mx-auto">
      {/* Main Content Card */}
      <div className="bg-white dark:bg-background-dark/50 border border-slate-200 dark:border-slate-800 rounded-xl p-8 shadow-sm">
        ...
        <div className="space-y-6">
          <OnboardingToggle
            ...
            onChange={(checked) =>
              onChange({ ...data, autoCreateTasks: checked })
            }
          />
          <OnboardingToggle
            ...
            onChange={(checked) =>
              onChange({ ...data, askBeforeScheduling: checked })
            }
          />
          <OnboardingToggle
            ...
            onChange={(checked) =>
              onChange({ ...data, proactiveSuggestions: checked })
            }
          />
          <OnboardingToggle
            ...
            onChange={(checked) =>
              onChange({ ...data, endOfDayReflection: checked })
            }
          />
        </div>
          ...
          <div className="bg-slate-100 dark:bg-slate-800/50 rounded-xl p-5 border border-slate-200 dark:border-slate-800 flex flex-col gap-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex flex-col gap-1">
                <div className="bg-white dark:bg-background-dark rounded-lg rounded-tl-none px-4 py-2 text-sm text-slate-700 dark:text-slate-300 max-w-[90%] border border-slate-200 dark:border-slate-800">
