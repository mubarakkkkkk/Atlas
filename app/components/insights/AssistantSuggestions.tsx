...
export function AssistantSuggestions() {
  return (
    <div className="bg-white dark:bg-primary/5 p-6 rounded-xl border border-slate-200 dark:border-border/10 shadow-sm flex flex-col">
      ...
      <button className="w-full mt-6 py-2 border border-border/20 hover:bg-primary/5 rounded-lg text-xs font-semibold text-primary transition-colors uppercase tracking-wider">
